...
class Student(Person):
    ...
    def __repr__(self):
        return super().__repr__() + ' - Info: ' + str(self.university) + ' ' + str(self.faculty) + ' ' + str(self.course) + ', Score: ' + str(self.middle_score)
...
class Teacher(Person):
    ...
    def __repr__(self):
        return super().__repr__() + ' - Info: ' + str(self.university) + ' ' + str(self.faculty) + ' ' + str(self.discipline) + ', Years at university: ' + str(self.experience) + ', Salary: ' + self.salary.print()




### To Do: Import class Money (dont use explicit in this file)
